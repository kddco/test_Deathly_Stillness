...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04A92750;
	constexpr int32 AppendString      = 0x01059F60;
	constexpr int32 GNames            = 0x04A56400;
	constexpr int32 GWorld            = 0x04BDAAC0;
	constexpr int32 ProcessEvent      = 0x0124ACE0;

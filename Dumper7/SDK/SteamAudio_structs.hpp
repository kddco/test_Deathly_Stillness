...
static_assert(sizeof(FSteamAudioBakedDataInfo) == 0x000030, "Wrong size on FSteamAudioBakedDataInfo");
...
static_assert(offsetof(FSteamAudioBakedDataInfo, EndpointRadius) == 0x000024, "Member 'FSteamAudioBakedDataInfo::EndpointRadius' has a wrong offset!");
static_assert(offsetof(FSteamAudioBakedDataInfo, Size) == 0x000028, "Member 'FSteamAudioBakedDataInfo::Size' has a wrong offset!");
